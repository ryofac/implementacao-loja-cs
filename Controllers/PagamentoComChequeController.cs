...
namespace ryanAps.Controllers
{
    public class PagamentoComChequeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroDoCheque,Banco,Id,NomeDoCobrado,InformacoesAdcionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroDoCheque,Banco,Id,NomeDoCobrado,InformacoesAdcionais")] PagamentoComCheque pagamentoComCheque)
        {
